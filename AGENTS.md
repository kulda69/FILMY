...
- Jednoduchá verze (start): filtrování a řazení katalogu podle žánrů, hodnocení, roku a ručně nastavených preferencí, odvozeno z historie + hodnocení. PostgreSQL read model.
- Chytřejší verze (později): embeddingy popisů přes Ollama (nomic-embed-text), vektorové vyhledávání a qwen3:14b pro slovní zdůvodnění doporučení.
